...
namespace Fractural.Utils
{
	...
	public static class CSharpScriptUtils
	{
		...
		static CSharpScriptUtils()
		{
			...
			{
				GD.Print("Had trouble reading CSHARP_SCRIPTS_TABLE_PATH. Maybe the file doesn't exist? Please enable the FracturalCommons plugin once in the editor to generate this file.");
			}
		}
